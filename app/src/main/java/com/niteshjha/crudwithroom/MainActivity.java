package com.niteshjha.crudwithroom;
...
import com.niteshjha.crudwithroom.Room.MyDatabase;
import com.niteshjha.crudwithroom.Room.Student;
        ...
        read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i =0; i<stuData.size(); i++){
                    ...
                    Toast.makeText(MainActivity.this,String.valueOf(stuData.get(i).getStuId() +": "+
                            stuData.get(i).getStuFirstName()+": "+ stuData.get(i).getStuLastName()+": "+
                            stuData.get(i).getStuClass()) , Toast.LENGTH_SHORT).show();
